...
if __name__ == '__main__':
    ...
    # Use a Tweets datas to this part
    print(divider())
    print(json.dumps(ORIGINAL, indent=2)[0:100])
    print(divider())
    print(type(ORIGINAL))
    print(divider())
    print(ORIGINAL.keys())

    # # User https://jsoneditoronline.org/
    # # Visualize all data with This Tool
    # # We can see all Keys and all nested Data

    # Display data for Second ORIGINAL Key
    # Second Key = statuses
    # Apply a indent property do prettify
    print('\n')
    print(divider())
    print('Level2 of tweets')
    ORIGINAL2 = ORIGINAL['statuses']
    print(type(ORIGINAL2))
    print(divider())
    print(len(ORIGINAL2))

    # # Display ORIGINAL2 First Item
    # print('\n')
    # print(divider())
    # for item in ORIGINAL2:
    for item in ORIGINAL2[:1]:
        print('Level3 of tweets')
        print(json.dumps(item, indent=2)[:30])
        print(type(item))
        print(item.keys())
        print(divider(40))
        print('Level4 of tweets: User who wrote the tweet')
        USER = item['user']
        print(type(USER))
        print(USER.keys())
        print(divider(30))
        print('Level5 of tweets: Screen Name of User')

    #     # Make the variable to global
    #     # We can access a data after treatment
    #     global SCREEN_NAME, CREATED_AT
    ...
    # print('\n')
    # print(divider())
    # print(SCREEN_NAME, CREATED_AT)
    # print(divider())
    # print('Screen Name: {}\nDate: {}'.format(SCREEN_NAME, CREATED_AT))
    # print(divider())

    # # We can combine Keys for reduce expression
    # # We can just combien KEYS for explicit Way
    # # Use a Nestead Iteration and Combinate Key
    # print('\n')
    # for item in ORIGINAL2:
    #     print(divider())
    #     print(item['user']['screen_name'])
    #     print(item['user']['created_at'])

    # # Ici la technique consiste donc a debugger
    # # Niveau par Niveau de la data afin de savoir
    # # Quels sont les éléments et les types contenus
    # # Dans la NESTED data avant de combiner les Cles
    # # Pour un code plus simple et lisible
